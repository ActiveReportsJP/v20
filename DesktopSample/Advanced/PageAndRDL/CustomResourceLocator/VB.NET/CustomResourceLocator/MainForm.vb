...
Public Class MainForm
	...
	Private Sub showReport_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles showReport.Click
		Dim reportData As Stream = Me.GetType.Assembly.GetManifestResourceStream("ActiveReports.Samples.CustomResourceLocator.DemoReport.rdlx")
