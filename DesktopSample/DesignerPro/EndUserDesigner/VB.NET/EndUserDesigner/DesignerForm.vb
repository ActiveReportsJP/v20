...
Public Class DesignerForm
	...
	Private Const ReportPartsDirectoryKey As String = "Designer.Controls.ReportPartsDirectory"
	Private Const ShowReportsLibraryKey As String = "Designer.Controls.ShowReportsLibrary"
