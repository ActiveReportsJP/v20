...
namespace ActiveReports.Samples.ReportWizard.UI.WizardSteps
{
	partial class SelectGroupingFields
	{
		...
		private void InitializeComponent()
		{
			...
			this.availableGroups = new ActiveReports.Samples.ReportWizard.UI.DragDropListBox();
			this.SuspendLayout();
			// 
			...
			this.availableGroups.GetDataObject += new System.EventHandler<ActiveReports.Samples.ReportWizard.UI.DragDropListBox.DataObjectEventArgs>(this.availableGroups_GetDataObject);
			this.availableGroups.GetDragEffects += new System.EventHandler<ActiveReports.Samples.ReportWizard.UI.DragDropListBox.DragDropEffectsEventArgs>(this.availableGroups_GetDragEffects);
			// 
		...
		private ActiveReports.Samples.ReportWizard.UI.DragDropListBox availableGroups;
	}
}
