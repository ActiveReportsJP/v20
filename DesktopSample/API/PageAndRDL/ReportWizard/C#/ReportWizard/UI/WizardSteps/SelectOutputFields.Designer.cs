...
namespace ActiveReports.Samples.ReportWizard.UI.WizardSteps
{
	partial class SelectOutputFields
	{
		...
		private void InitializeComponent()
		{
			...
			this.availableOutputFields = new ActiveReports.Samples.ReportWizard.UI.DragDropListBox();
			...
			this.availableOutputFields.GetDataObject += new System.EventHandler<ActiveReports.Samples.ReportWizard.UI.DragDropListBox.DataObjectEventArgs>(this.availableOutputFields_GetDataObject);
			this.availableOutputFields.GetDragEffects += new System.EventHandler<ActiveReports.Samples.ReportWizard.UI.DragDropListBox.DragDropEffectsEventArgs>(this.availableOutputFields_GetDragEffects);
