...
Public Class PrintMultiplePages
	...
	Private _numberOfPagesPerPrinterPage As Integer = 6 ' 偶数である必要があります。
	...
	Private Sub btnAPIprint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAPIprint.Click
		apiViewer.Document.PrintOptions.PageScaling = GrapeCity.ActiveReports.Printing.PageScaling.MultiplePages
