...
Public Class AnnotationForm
	...
	Private Sub tsbExport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles _tsbAnnotation.Click
		...
		annoImg.BackgroundImage = ToInternalImage(imgStamp) ' 画像
		...
		arvMain.Refresh()
	End Sub
	Public Function ToInternalImage(ByVal image As System.Drawing.Image) As GrapeCity.ActiveReports.Document.Drawing.Image
