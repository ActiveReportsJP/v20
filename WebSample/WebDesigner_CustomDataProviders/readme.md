# Webデザイナ カスタムデータプロバイダ(SQLite,OData) サンプル

このサンプルActiveReports.NETのWebデザイナーでカスタムデータプロバイダー（SQLiteおよびOData）を使用する方法を示しています。
...
## 引用
このサンプルでは、次のサイトにあるNorthwindデータベースのsqlite版を使用しています: https://github.com/jpwhite3/northwind-SQLite3