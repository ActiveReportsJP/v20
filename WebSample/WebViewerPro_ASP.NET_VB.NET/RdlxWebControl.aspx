<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RdlxWebControl.aspx.vb" Inherits="GrapeCity.ActiveReports.Samples.Web.RdlxWebControl" culture="auto"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="HtmlViewer" class="tabcontent">
            <ActiveReportsWeb:WebViewer class="viewer" ViewerType="HtmlViewer" ReportName="RdlxReports\\SalesReceipt.rdlx" runat="server" LocalizationJson="ar-webviewer-locale.json"/>
        </div>
        <div id="RawHtml" class="tabcontent">
            <ActiveReportsWeb:WebViewer class="viewer" ViewerType="RawHtml" ReportName="RdlxReports\\SalesReceipt.rdlx" runat="server"/>
        </div>
        <div id="AcrobatReader" class="tabcontent">
            <ActiveReportsWeb:WebViewer class="viewer" ViewerType="AcrobatReader" ReportName="RdlxReports\\SalesReceipt.rdlx" runat="server"/>
        </div>
    </body>
</html>