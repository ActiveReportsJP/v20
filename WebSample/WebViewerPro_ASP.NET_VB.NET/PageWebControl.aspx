<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PageWebControl.aspx.vb" Inherits="GrapeCity.ActiveReports.Samples.Web.PageWebControl" culture="auto"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="HtmlViewer" class="tabcontent">
            <ActiveReportsWeb:WebViewer class="viewer" ViewerType="HtmlViewer" LocalizationJson="ar-webviewer-locale.json" ReportName="PageReports\\Invoice_Grouped.rdlx" runat="server"/>
        </div>
        <div id="RawHtml" class="tabcontent">
            <ActiveReportsWeb:WebViewer class="viewer" ViewerType="RawHtml" ReportName="PageReports\\Invoice_Grouped.rdlx" runat="server"/>
        </div>
        <div id="AcrobatReader" class="tabcontent">
            <ActiveReportsWeb:WebViewer class="viewer" ViewerType="AcrobatReader" ReportName="PageReports\\Invoice_Grouped.rdlx" runat="server"/>
        </div>
    </body>
</html>