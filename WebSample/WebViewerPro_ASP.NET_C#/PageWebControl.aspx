<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageWebControl.aspx.cs" Inherits="GrapeCity.ActiveReports.Samples.Web.PageWebControl" culture="auto"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="HtmlViewer" class="tabcontent">
            <ActiveReportsWeb:WebViewer class="viewer" ViewerType="HtmlViewer" ReportName="PageReports\\Invoice_Grouped.rdlx" runat="server" LocalizationJson="ar-webviewer-locale.json" />
        </div>
